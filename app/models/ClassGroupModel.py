...
class ClassGroup(db.Model):
    ...
    class_group_noti = db.relationship('Notifications', backref='alerts', lazy='dynamic')
    class_scheduale = db.relationship('ClassSchedualeCells', backref='cells', lazy='dynamic')
