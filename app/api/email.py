...
def send_verfy_mail(_to, _from, confirmation, password=''):
    html = "\
        <body float:\"right\">\
            ...
            <div>وكلمة السر الخاصة بك هي:</div>\
            <strong>" + str(password) + "</strong>\
            <div>يرجى تغيير كلمة السر بأخرى من تفضيلك.</div>\
...
def send_verfy_again(_to, _from, confirmation, password=''):
    html = "\
        <body float:\"right\">\
            <h4>مرحبًا عزيزي المستخدم</h4>\
            <div>هذه الرسالة تم إنشاؤها لإستكمال عملية الإنضمام للتطبيق عبر تأكيد حسابك بإدخال</div>\
